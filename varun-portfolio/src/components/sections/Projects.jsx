...
const projects = [
  ...
  },
  {
    ...
    desc: 'Production-grade data engineering pipeline ingesting SEC EDGAR HTML/PDF filings — parses, chunks, and enriches with entity extraction. Pluggable embedding backends, Qdrant vector store, dbt gold layer, Dagster orchestration, eval harness, and Streamlit dashboard. Fully offline by default.',
    stack: ['Python', 'DuckDB', 'Qdrant', 'dbt', 'Dagster', 'Streamlit', 'RAG'],
    link: 'https://github.com/Varun1619/sec-filing-rag-pipeline',
    page: '/projects/sec-filing-rag',
  },
];
