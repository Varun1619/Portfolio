...
ORDER BY bucket`,
  ...
  },
  {
    ...
    demo: 'https://sec-filing-rag-pipeline.streamlit.app',
    metrics: [
      { label: 'Filings indexed', value: '20', color: '#00e87b' },
      { label: 'Chunks (demo)', value: '2,342', color: '#4fc3f7' },
      { label: 'Embedding backends', value: '4 (offline → cloud)', color: '#f0f0f0' },
